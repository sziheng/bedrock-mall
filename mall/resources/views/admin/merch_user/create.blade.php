            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <form action="{{route('webMerchUserPostCreate')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label class="col-sm-1 control-label must">商户名称</label>
                                <div class="col-sm-7"  style="padding-right:0;" >
                                    <input type="text" name="merchname" class="form-control" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"  style="padding-right:0;" >
                                    <input type="text" name="salecate" class="form-control" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"  style="padding-right:0;" >
                                    <textarea class="form-control" name="desc" value="" /></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <label class="radio-inline"><input type="radio" name="status" value="1" checked="true" /> 允许入驻</label>
                                    <label class="radio-inline"><input type="radio" name="status" value="0" /> 暂停中</label>
                                </div>
                            </div>
