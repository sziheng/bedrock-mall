...
<div id='tboption' style="padding-left:15px;@if($good['hasoption'] !=1) display:none @endif" >
    ...
    <table class="table">
        <tr>
            <td>
                <h4><a href="javascript:;" class='btn btn-primary' id='add-spec' style="margin-top:10px;margin-bottom:10px;" title="添加规格"><i class='fa fa-plus'></i> 添加规格sss</a>
                ...
                @endif
                    @endforeach
                        ...
                        for (var i = 0; i < newlen; i++) {
                            ...
                            var val ={ id : "",title:titles,{loop $levels $level}{if $level['key']=='default'} level{$level['key']}: '',{else} level{$level['id']}: '',{/if}{/loop}costprice : "",productprice : "",marketprice : "",weight:"",productsn:"",goodssn:"",virtual:virtuals };
                                                ...
                                                if ($(".isdiscount_discounts_id_" + ids).length > 0) {
                                                    ...
                                                    function refreshCommission() {
                                                        ...
                                                        for (var i = 0; i < newlen; i++) {
                                                            ...
                                                            var val ={ id : "",title:titles,{loop $commission_level $level} {if $level["key"] == "default"}level{$level['key']}: '',{else}level{$level['id']}: '',{/if}{/loop}costprice : "",productprice : "",marketprice : "",weight:"",productsn:"",goodssn:"",virtual:virtuals };
                                                            {loop $commission_level $level}
                                                            {if $level["key"] == "default"}
                                                            ...
                                                            {/if}
                                                                {/loop}
                                                                    ...
                                                                    {loop $commission_level $level}
                                                                    hh += '<td>';
                                                                    var level_temp = {if $level['key'] == 'default'}level{$level['key']}{else}level{$level['id']}{/if};
