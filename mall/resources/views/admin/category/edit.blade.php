                            ...
                            <form class="form-horizontal form-label-left" novalidate action="/web/category"  method="POST" enctype="multipart/form-data">
                             ...
                             {{--   <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="displayorder" value="{{$category->displayorder}}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="displayorder"  value="0" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="name" value="{{$category->name}}" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name"  required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" value="{{$category->description}}" id="description" name="description" class="form-controlcol-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12" id="wrapper">
                                        ...
                                        <input id="fileUpload" type="file" name="thumb" value="{{$category->thumb}}" /><br />
                                        <div id="image-holder">
                                            @if($category->thumb)
                                                <img src="{{$category->thumb}}" alt="" class="thumb-image" style="width:300px">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="advurl" name="advurl"  value="{{$category->advurl}}" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>
                                            <input type="checkbox" class="js-switch" @if($category->ishome) checked @endif name="ishome" class="form-controlcol-md-7 col-xs-12" />
                                        </label>
                                    </div>
                                </div>
